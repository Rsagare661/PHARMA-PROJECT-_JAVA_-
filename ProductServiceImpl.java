...
public class ProductServiceImpl implements ProductService {
    ...
    PharmaProduct myDtoToEntity(PharmaProductDto pharmaProductDto){
    return 	modelMapper.map(pharmaProductDto, PharmaProduct.class);
    }
    
     PharmaProductDto myEntityToDto(PharmaProduct pharmaProduct){
    	return modelMapper.map(pharmaProduct, PharmaProductDto.class);
    }
...
//    	PharmaProduct myEntity = myDtoToEntity(productDto);
//    	PharmaProduct savedEntity = productRepository.save(myEntity);
//    	
//    	PharmaProductDto myDto = myEntityToDto(savedEntity);
//    	return myDto;
    	
//    	PharmaProduct pr=new PharmaProduct();
